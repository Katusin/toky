...
async def aria_start():
    ...
    aria2_daemon_start_cmd.append("--check-integrity=true")
    aria2_daemon_start_cmd.append("--content-disposition-default-utf8=true")
    aria2_daemon_start_cmd.append("--auto-file-renaming=true")
    aria2_daemon_start_cmd.append("--max-file-not-found=0")
    aria2_daemon_start_cmd.append("--user-agent=Wget/1.12")
